...
export function KubeStellarVisualization() {
  ...
  useEffect(() => {
    if (disableCanvas && isPlaywrightTesting) {
      ...
      console.info(`[INFO] Canvas/WebGL disabled via ${reason}`);
    }
                ...
                >
                  ...
                  <div
                    style={{
                      ...
                      bottom: 0,
                      backgroundImage: `
                        radial-gradient(circle at 25% 25%, #6236FF22 0%, transparent 50%),
                        radial-gradient(circle at 75% 75%, #00C2FF22 0%, transparent 50%),
                        radial-gradient(circle at 50% 50%, #FF5E8422 0%, transparent 50%)
                      `,
                  ...
                  >
                    <div
                      ...
                      style={{
                        ...
                        fontWeight: 'bold',
                        marginBottom: '1rem',
                        background: 'linear-gradient(45deg, #6236FF, #00C2FF, #FF5E84)',
