...
const PluginManagementLazy = lazy(
  () => import(/* webpackPrefetch: true */ '../pages/PluginManagement')
);
    ...
    children: [
      ...
      },
      {
        ...
        element: (
          <ProtectedRoute>
            <Suspense
              fallback={<LoadingFallback message="Loading plugin management..." size="medium" />}
            >
              <PluginManagementLazy />
            </Suspense>
          </ProtectedRoute>
        ),
      },
