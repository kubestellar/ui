...
const ExploreApps: React.FC<ExploreAppsProps> = ({ onRefresh }) => {
    ...
    const hardcodedPlugins: Plugin[] = [
      {
        ...
        version: "1.2.0",
        description: "Real-time monitoring of Kubernetes clusters",
        rating: 4.5,
        downloads: 24500,
      ...
      },
      {
        ...
        version: "2.1.3",
        description: "Automated cluster backups and restoration",
        rating: 4.8,
        downloads: 18200,
      ...
      },
      {
        ...
        version: "0.9.4",
        description: "Cloud resource cost optimization tool",
        rating: 4.2,
        downloads: 11500,
      ...
      },
      {
        ...
        version: "1.5.1",
        description: "Automated security compliance checks",
        rating: 4.6,
        downloads: 16700,
      ...
      {
        name: "auto-scaler",
        displayName: "Auto Scaler",
        version: "2.3.0",
        description: "Dynamic resource scaling based on workload",
        rating: 4.7,
        downloads: 29800,
  ...
  const handleInstall = (pluginName: string) => {
    ...
    api.post('/api/plugins/install', { name: pluginName })
    ...
    <Grid container spacing={3}>
      {Array.from({ length: 8 }).map((_, index) => (
        <Grid item xs={12} sm={6} md={4} lg={3} key={index}>
          ...
          >
            <CardContent>
              <Skeleton variant="text" width="80%" height={32} sx={{ bgcolor: 'rgba(100, 116, 139, 0.3)' }} />
              <Skeleton variant="text" width="100%" height={20} sx={{ bgcolor: 'rgba(100, 116, 139, 0.3)', mt: 1 }} />
              <Skeleton variant="text" width="90%" height={20} sx={{ bgcolor: 'rgba(100, 116, 139, 0.3)' }} />
              <Box sx={{ display: 'flex', gap: 1, mt: 2 }}>
                <Skeleton variant="rectangular" width={100} height={20} sx={{ bgcolor: 'rgba(100, 116, 139, 0.3)', borderRadius: 1 }} />
                <Skeleton variant="rectangular" width={80} height={20} sx={{ bgcolor: 'rgba(100, 116, 139, 0.3)', borderRadius: 1 }} />
              </Box>
            </CardContent>
            <CardActions>
              <Skeleton variant="rectangular" width={100} height={36} sx={{ bgcolor: 'rgba(100, 116, 139, 0.3)', borderRadius: 1 }} />
            </CardActions>
          </Card>
        </Grid>
      ))}
        ...
        {loading ? (
          ...
          <Grid container spacing={3} sx={{ pb: 3 }}>
            {availablePlugins.map((plugin, index) => (
              <Grid item xs={12} sm={6} md={4} lg={3} key={plugin.name}>
                <Zoom 
                  in={true} 
                        ...
                        <Box sx={{ display: 'flex', gap: 1, flexWrap: 'wrap' }}>
                          ...
                          {plugin.downloads !== undefined && (
                            <Chip
                              ...
                              label={`${formatDownloads(plugin.downloads)}`}
                              size="small"
                              sx={{
