...
export const AddWebhookDialog = ({
  ...
  return (
    ...
    >
      <DialogTitle sx={{ padding: "16px 24px", borderBottom: `1px solid ${theme === "dark" ? "#444444" : "#e0e0e0"}` }}>
        <Typography variant="subtitle1" sx={{ fontWeight: 600, color: theme === "dark" ? "#E0E0E0" : "#333", fontSize: "20px" }}>
          Setup Webhook
        </Typography>
      </DialogTitle>
      <DialogContent sx={{ padding: "24px" , backgroundColor: theme === "dark" ? "#00000033" : "#00000003" }}>
        <Box >
          {/* Section 1: Local Development Using Smee.io */}
          <Box sx={{ border: `1px solid ${theme === "dark" ? "#444444" : "#D3D3D3"}`, padding: "18px", mt: 4 , backgroundColor: theme === "dark" ? "#00000033" : "#00000003"}}>
            <Typography variant="subtitle2" sx={{ fontWeight: 600, fontSize: "16px", color: theme === "dark" ? "#E0E0E0" : "#333", mb: 2 }}>
            ...
            <Box>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "#64748B", fontSize: "12px", marginTop: "4px" }}>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                  ...
                  <Box sx={{ flex: 1 }}>
                    <Typography variant="body2" sx={{ color: "#64748B", fontSize: "12px", mb: 1, marginTop: "4px" }}>
            ...
            <Box>
              ...
              >
                <Box sx={{ display: "flex", alignItems: "flex-start" }}>
                  ...
                  <Typography variant="body2" sx={{ color: "#64748B", fontSize: "12px", marginTop: "4px" }}>
                    Keep your Go server running in the background (<code>nohup</code> or <code>systemd</code>).
                  </Typography>
                </Box>
              </Box>
            </Box>
