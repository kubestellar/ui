...
-- Drop tables created in up migration
DROP TABLE IF EXISTS plugin_payment CASCADE;
DROP TABLE IF EXISTS plugin_version CASCADE;
DROP TABLE IF EXISTS plugin_screenshots CASCADE;
DROP TABLE IF EXISTS plugin_categories CASCADE;
DROP TABLE IF EXISTS plugin_reply_feedback CASCADE;
